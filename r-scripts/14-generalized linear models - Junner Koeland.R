...
#just as a normal linear model, change to glma later
...
#not really a normal distribution, but the poisson is better than the gaussian
...
AIC(m8,m7)
anova(m8,m7)
#yes it matters, the deiiference between the treatments is significant
